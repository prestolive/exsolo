package cn.exsolo.builder.sdk.item.boot;

import cn.hutool.core.util.EnumUtil;
import cn.exsolo.batis.core.BaseDAO;
import cn.exsolo.batis.core.Condition;
import cn.exsolo.builder.ex.EsBuilderException;
import cn.exsolo.builder.sdk.item.ItemOriginEnum;
import cn.exsolo.builder.sdk.item.ItemSchemaEnum;
import cn.exsolo.builder.sdk.item.po.ItemPO;
import cn.exsolo.builder.sdk.item.po.ItemTagPO;
import cn.exsolo.builder.sdk.item.po.ItemTextPO;
import cn.exsolo.builder.sdk.item.stereotype.Item;
...
public class EsItemBootAware implements ApplicationContextAware {
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        ...
        List<ItemTagPO> allItems = list.stream().map(clz -> {
            ...
            po.setSchema(itemAnna.schema().name());
    ...
    private void initTag(List<ItemTagPO> allItems) {
        ...
        for (ItemTagPO item : allItems) {
            ...
            if (exist == null) {
                ...
                if (ObjectUtils.notEqual(item.getName(), exist.getName()) || ObjectUtils.notEqual(item.getSchema(), exist.getSchema())) {
        ...
        try {
            ...
            for (ItemTagPO item : allItems) {
                ...
                for(Map.Entry<String,Object> entry:map.entrySet()){
                    ...
                    po.setOrigin(ItemOriginEnum.SOURCE.name());
                    po.setSchema(ItemSchemaEnum.ENUM.name());
                    po.setStatus(0);
                    po.setText(false);
