...
import static cn.santoise.batis.act.utils.StandType.*;
...
public class DbFieldUtil {
    ...
    public static ActSuggestDatatypeBO getMyUnderstanding(String name, String sourceType, DatabaseType targetDatabase) {
