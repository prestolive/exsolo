...
public class AccessTokenUtil {
    ...
    public static String createAccessToken(HttpServletRequest request, String userId, String loginCode, String ticketId, int expireTimes, String privateKey) {
    ...
    public static void verifyAccessToken(String token, String publicKeyStr) {
